...
class StoreResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> StoreResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/yolken-stainless/yolken-test-13a-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> StoreResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/yolken-stainless/yolken-test-13a-python#with_streaming_response
        """
