...
from ._exceptions import APIStatusError, YolkenTest13aError
...
class YolkenTest13a(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest13a client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_13A_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest13aWithRawResponse:
        return YolkenTest13aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest13aWithStreamedResponse:
        return YolkenTest13aWithStreamedResponse(self)
...
class AsyncYolkenTest13a(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest13a client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest13aWithRawResponse:
        return AsyncYolkenTest13aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest13aWithStreamedResponse:
        return AsyncYolkenTest13aWithStreamedResponse(self)
...
class YolkenTest13aWithRawResponse:
    _client: YolkenTest13a

    def __init__(self, client: YolkenTest13a) -> None:
        self._client = client
...
class AsyncYolkenTest13aWithRawResponse:
    _client: AsyncYolkenTest13a

    def __init__(self, client: AsyncYolkenTest13a) -> None:
        self._client = client
...
class YolkenTest13aWithStreamedResponse:
    _client: YolkenTest13a
...
class AsyncYolkenTest13aWithStreamedResponse:
    _client: AsyncYolkenTest13a
...
AsyncClient = AsyncYolkenTest13a
